...
var (
	...
	clientUserMap  map[uint32]*ClientNode // key : uid , for all verified user
	clientNodeSeed int
)
...
func init() {
	...
	clientUserMap = make(map[uint32]*ClientNode)
}
